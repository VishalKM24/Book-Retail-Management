...
<body onload="changeHeader(),addField();">
	...
	<div>
			<br/><div align="center">
		<button class="button1" style="width:250px;  border-radius: 8px; font-size:20px;" align="center" disabled>Add Purchase Bill</button>
		</div><br/>
			<form action="addpurchasebilldata.jsp" method="post">
