			...
			if(h!=0)
			{
				...
				if(f!=0)
				{
					...
					if(g==1)
					{
						...
						Class.forName("com.mysql.jdbc.Driver");
						Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/rsms","root","dbms");
						...
						if(ab==0)
						{
							...
							if(fg==1)
							{
								...
								{
									String Query8 ="insert into purchase_details values('"+billno+"','"+code[i]+"','"+quantity[i]+"','"+price[i]+"','"+amount[i]+"')";
								...
								out.println("<script type=\"text/javascript\">");
							   	...
							   	out.println("location='purchasebill.jsp';");
							   	out.println("</script>");
							}
							else
							{
